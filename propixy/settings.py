"""
Django settings for Propixy project.
...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-change-this-in-production-propixy-2024')
...
WSGI_APPLICATION = 'propixy.wsgi.application'
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'mdsadiqulislam446@gmail.com')
